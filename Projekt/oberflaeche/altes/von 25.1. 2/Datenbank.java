...
public class Datenbank {
	...
	//public static int Anzahlarbeiten = 0;
		...
		public void verbinden(){
			...
			String url = "jdbc:mysql://localhost:22456/projekt";
	...
	/*	public int Anzahlstudiengaenge(){
		...
		public String[] vergleichen(){
	        ...
	        String[] Resultat = new String[AnzahlArbeit()];
	        try{
	        	//Connection con = null;
	            // Statement generieren
	            Statement stmt = con.createStatement();
		...
		public String[][] datenStudent(){
	        ...
	        try{
	            ...
	            // Statement generieren
	            Statement stmt = con.createStatement();
	            String Matrikelnummer = "select * from Student;";
	            // Abfrage ausfuehren und ResultSet erhalten
				...
				*/
	            ...
	            int j=0;
	            while(rs1.next()){
	                Resultat[i][j] = rs1.getString("Matrikelnummer");
	                Resultat[i][j+1] = rs1.getString("Name");
	                Resultat[i][j+2] = rs1.getString("Semester");
	                Resultat[i][j+3] = rs1.getString("Studiengang");
	    ...
	    //Daten hinzufuegen
	    public void hinzufuegenStatus(String s){
	        try{
	        	//Connection con = null;
	            // Statement generieren
	            Statement stmt = con.createStatement();
	    ...
	    public void hinzufuegenStudiengang(String s){
	        try{
	        	//Connection con = null;
	            // Statement generieren
	            Statement stmt = con.createStatement();
	    ...
	    public void hinzufuegenProfessor(String[] daten) {
	        try{
	        	//Connection con = null;
	            // Statement generieren
	            Statement stmt = con.createStatement();
	    ...
	    public void hinzufuegenBetreuer(String[] daten) {
	        try{
	        	//Connection con = null;
	            // Statement generieren
	            Statement stmt = con.createStatement();
	    ...
	    public void hinzufuegenAbschlussarbeit(A o){
	        try{
	        	//Connection con = null;
	            // Statement generieren
	            Statement stmt = con.createStatement();
	            ...
	            if(o.Art.equals("BA")){
	                String hinzufuegenarbeit = "insert into Bachelorarbeit values('" + o.TitelArbeit  + "', '"+o.Matrikelnummer+ "', '" +o.PersonalnummerBetreuer+ "', '"+o.PersonalnummerProf1+ "', '" +o.Anmeldedatum+"', '"+o.Status+ "', '" +o.Note+ "');";
	                // Anweisung ausfuehren
