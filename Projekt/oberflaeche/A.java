package oberflaeche;
public class A {
	String Matrikelnummer="232323";
	String NameStudent="echo";
	String Studiengang="Informatik";
	String Semester="2";
	String TitelArbeit ="Informatik Projekt";
	String Art="BA";
	String PersonalnummerBetreuer="123452";
	String NameBetreuer ="DummyBetreuer";
	String InstitutBetreuer="DummyInstitut";
	String PersonalnummerProf1="232323";
	String PersonalnummerProf2="sdsdad";
	String NameProf ="DummyProf";
	String InstitutProf="asdasd";
	String Status="abgegeben";
	String Abgabetermin= "20111212";
	String Anmeldedatum ="232323";
	double Note = 1.3;
