...
public class DialogAbschlussarbeit extends JDialog {
    ...
    public DialogAbschlussarbeit(JFrame fenster, String[] datensatz, Methoden datenbank1){
        super(fenster, true);
	...
	text13 = new JLabel("Name");
	text14 = new JLabel("Professor");
	text15 = new JLabel("Name 1");
	text16 = new JLabel("Name 2");
	...
	speichern = new JMenuItem("Speichern");
        ...
        speichern.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String fehler = datenbank.speichernLogik(datensatz1);
                if (fehler == null) {
                    dispose();
                }else {
                    JOptionPane.showMessageDialog(dialog, "Sie haben eine inkonsistente Eingabe gemacht: \n" + fehler, "Fehler", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
