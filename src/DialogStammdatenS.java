...
public abstract class DialogStammdatenS extends JDialog {
	...
	public DialogStammdatenS(JFrame fenster, String[] datensatz, Datenbank datenbank1, String titel){
		super(fenster, true);
		...
		loeschen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	/*datenbank.loe...Status*/				if(loeschen((String)feld.getSelectedItem())) {
						dispose();
					} else {
